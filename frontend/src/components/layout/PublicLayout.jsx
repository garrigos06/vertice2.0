...
import { Home, Ticket, Radio, Calendar, User } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col relative">
      ...
      >
        <div className="max-w-7xl mx-auto px-5 md:px-8 h-16 flex items-center justify-between">
          <NavLink to="/" data-testid="brand-logo" className="flex items-center gap-3">
            <img src={LOGO_HORIZONTAL} alt="Vértice Sports" className="h-8 md:h-9" />
          </NavLink>
      ...
      <footer className="hidden md:block border-t border-white/5 bg-black/40">
        <div className="max-w-7xl mx-auto px-8 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <img src={LOGO_HORIZONTAL} alt="Vértice Sports" className="h-8 mb-3" />
          ...
          <div>
            <h4 className="font-display text-white/90 mb-3">Plataforma</h4>
            <ul className="space-y-2 text-sm text-white/60">
              <li><NavLink to="/bilhetes" className="hover:text-white">Bilhetes</NavLink></li>
              <li><NavLink to="/historico" className="hover:text-white">Histórico</NavLink></li>
              <li><NavLink to="/planos" className="hover:text-white">Planos</NavLink></li>
              <li><NavLink to="/calendario" className="hover:text-white">Calendário</NavLink></li>
            </ul>
          </div>
          <div>
            <h4 className="font-display text-white/90 mb-3">Conta</h4>
            <ul className="space-y-2 text-sm text-white/60">
              <li><NavLink to="/login" className="hover:text-white">Login</NavLink></li>
              <li><NavLink to="/cadastro" className="hover:text-white">Cadastro</NavLink></li>
              <li><NavLink to="/recuperar-senha" className="hover:text-white">Recuperar senha</NavLink></li>
            </ul>
          </div>
        </div>
