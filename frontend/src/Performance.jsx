      ...
      <section className="max-w-7xl mx-auto px-5 md:px-8 py-10 md:py-14">
        <div className="max-w-3xl">
          ...
          <p className="text-sm md:text-base text-white/50 mt-4 leading-relaxed max-w-2xl">
            Desempenho dos bilhetes
            publicados com uma metodologia
            padronizada e auditável,
            mantendo greens, reds e voids
            no histórico.
          </p>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-white/45 leading-relaxed mt-2">
                    ...
                    liquidado recebe stake
                    teórica de 1 unidade. GREEN
                    soma a odd total menos 1,
                    RED desconta 1 unidade e
                    VOID não altera o resultado.
                    O ROI flat é o lucro
                    acumulado dividido pelo
